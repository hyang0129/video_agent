...
## Extended Demo: Video Agent Long

This repo is the short-form sibling of a larger system, `video_agent_long`, that pushes the same artifact-driven design into long-form, chapter-based video production.

[![Ragnar Lothbrok demo](https://img.youtube.com/vi/AMfVYGuL-VQ/maxresdefault.jpg)](https://www.youtube.com/watch?v=AMfVYGuL-VQ)

*Extended output: Ragnar Lothbrok - a long-form historical video generated by `video_agent_long` as the next evolution of this codebase.*

**What "Video Agent Long" adds:**
- Deep research and source-grounded fact packaging before writing begins
- Hierarchical planning: thesis -> chapters -> scene beats
- Multi-chapter script generation with running context carried across the full video
- Performance direction, chapter-level pacing, and per-chapter render assets
- Avatar-driven presentation, lip sync, compositing, and final long-form render orchestration
- Worker/render split architecture with resumable phases and explicit artifact checkpoints

If you are evaluating this repo for engineering signal, the short-form pipeline here shows the core multi-agent artifact architecture. The Ragnar demo shows how that architecture scales into a more ambitious LMM-driven system for research-heavy, long-form narrative generation across planning, writing, visual production, voice, avatar acting, and final render assembly.
